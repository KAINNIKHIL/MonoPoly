          ...
          {myCards.map(([id, card]) => {
            ...
            return (
              <div
                ...
                className={`min-w-[120px] p-2 rounded-xl cursor-pointer border transition-all
                ${
                  active
          ...
          {Object.entries(players).map(([id, p]) => {
            ...
            return (
              <div
                key={id}
                onClick={() => setBuyer(id)}
                className={`px-3 py-1.5 rounded-full cursor-pointer text-sm transition-all whitespace-nowrap
                ${
                  active
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <input
            ...
            className="w-full p-2.5 rounded-xl bg-gray-700 outline-none border border-gray-600 focus:border-yellow-400"
